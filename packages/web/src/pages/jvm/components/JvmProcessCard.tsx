...
import { Play, Square, Info, Clock, User, Code, Zap, ChevronDown, ChevronUp } from 'lucide-react';
...
const JvmProcessCard: React.FC<JvmProcessCardProps> = ({ process, onRefresh }) => {
        ...
        <div className="flex items-center gap-2">
          ...
          {process.memory ? (
            <button
              ...
              disabled={loading}
              className="flex items-center gap-1 px-3 py-1.5 text-sm bg-red-500 text-white rounded hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
