...
export function NodeLogPage() {
  return (
    <div className="h-full flex flex-col gap-3 p-3">
      <div className="rounded-2xl border border-white/55 dark:border-primary-300/20 bg-white/75 dark:bg-slate-900/60 backdrop-blur-xl shadow-xl px-4 py-3">
        <div className="text-xs tracking-[0.28em] uppercase text-slate-400 mb-1">NODE RUNTIME</div>
